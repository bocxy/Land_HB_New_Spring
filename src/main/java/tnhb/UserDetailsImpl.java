...
public class UserDetailsImpl implements UserDetails {
  ...
  public UserDetailsImpl(Long id, String username, String role, String group_name, String privilege, String accesslevel1, String accesslevel2,String loggedin, String password) {
    this.id = id;
